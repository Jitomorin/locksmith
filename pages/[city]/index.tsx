    ...
    <>
      ...
      <HomepageWrapper>
        <WhiteBackgroundContainer>
          ...
          <div className="grid grid-cols-1  sm:grid-cols-3 lg:grid-cols-4 gap-10 max-w-[90%] mx-auto">
            ...
            {/* <div className="col-span-1 md:col-span-3 md:flex align-middle items-center justify-center"></div> */}
          </div>
        </WhiteBackgroundContainer>
